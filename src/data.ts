...
export const INITIAL_CHECKLIST: ChecklistItem[] = [
  ...
  { id: '13', pilar: 'Sustentabilidade', bloco: 'Gestão de Acidente', trilha: 'Básico bem feito', item: 'Relatórios de acidente (CAT) são preenchidos e investigados no prazo?', descricao: 'Verificar se todos os acidentes geram um relatório de investigação com causa raiz.', exigeEvidencia: true, ativo: true, order: 1, code: 'SSM-GES-01' },
  { id: '14', pilar: 'Sustentabilidade', bloco: 'Gestão de Acidente', trilha: 'Básico bem feito', item: 'Plano de ação para acidentes é acompanhado semanalmente?', descricao: 'Conferir se as ações corretivas e preventivas são registradas e têm seu status atualizado.', exigeEvidencia: true, ativo: true, order: 2, code: 'SSM-GES-02' },
  { id: '15', pilar: 'Sustentabilidade', bloco: 'Ergonomia', trilha: 'Básico bem feito', item: 'Análise Ergonômica do Trabalho (AET) está atualizada?', descricao: 'Verificar se o documento existe e contempla todas as funções atuais do CD.', exigeEvidencia: true, ativo: true, order: 1, code: 'SSM-ERG-01' },
  { id: '16', pilar: 'Sustentabilidade', bloco: 'Ergonomia', trilha: 'Básico bem feito', item: 'Equipe recebeu treinamento sobre postura e ergonomia?', descricao: 'Checar listas de presença ou registros de treinamento sobre práticas ergonômicas.', exigeEvidencia: true, ativo: true, order: 2, code: 'SSM-ERG-02' },
  ...
  { id: '18', pilar: 'Sustentabilidade', bloco: 'Segurança Sanitária', trilha: 'Básico bem feito', item: 'Plano de limpeza e higienização de áreas comuns e armazém é seguido?', descricao: 'Conferir cronogramas de limpeza e registros de execução.', exigeEvidencia: true, ativo: true, order: 1, code: 'SSM-SEG-01' },
  { id: '19', pilar: 'Sustentabilidade', bloco: 'Segurança Sanitária', trilha: 'Básico bem feito', item: 'Controle de pragas está em dia?', descricao: 'Verificar o certificado de execução do serviço, válido para o período.', exigeEvidencia: true, ativo: true, order: 2, code: 'SSM-SEG-02' },
  ...
  { id: '23', pilar: 'Sustentabilidade', bloco: 'Saúde', trilha: 'Básico bem feito', item: 'PCMSO está atualizado e os ASOs estão em dia?', descricao: 'Verificar a validade do PCMSO e a conformidade dos ASOs dos colaboradores.', exigeEvidencia: true, ativo: true, order: 1, code: 'SSM-SAU-01' },
  ...
  { id: '26', pilar: 'Sustentabilidade', bloco: 'Comportamento Seguro', trilha: 'Básico bem feito', item: 'Programa de observação de comportamento seguro (ex: DDS) está ativo?', descricao: 'Verificar a realização de Diálogos Diários de Segurança e os temas abordados.', exigeEvidencia: true, ativo: true, order: 1, code: 'SSM-COM-01' },
