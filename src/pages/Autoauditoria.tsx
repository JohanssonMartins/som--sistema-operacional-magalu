      ...
      <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg shadow-sm overflow-hidden">
        <div className="grid grid-cols-3 divide-x divide-gray-200 dark:divide-zinc-800 border-b border-gray-200 dark:border-zinc-800 p-4 text-center">
          <div>
            ...
            <div className="text-[10px] text-gray-400 dark:text-zinc-500">({totalRespondidos - totalNa}/{totalItems - totalNa} itens)</div>
          </div>
          <div>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-zinc-800">
              {resumoLocal.map(row => (
                <tr key={row.pilar} className="hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-colors">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-1.5 flex items-center gap-2">
                          ...
                          <span className="text-xs font-semibold text-gray-600 dark:text-zinc-400 shrink-0">
                  ...
                  <td className="px-3 py-3 text-center align-bottom">{row.total}</td>
                  <td className="px-3 py-3 text-center align-bottom text-gray-500">{row.na > 0 ? row.na : '—'}</td>
                  <td className="px-3 py-3 text-center align-bottom font-bold text-emerald-600">{row.conforme}</td>
                  <td className="px-3 py-3 text-center align-bottom font-bold text-amber-500">{row.parcial}</td>
                  <td className="px-3 py-3 text-center align-bottom font-bold text-red-600">{row.naoConforme}</td>
                  <td className="px-3 py-3 text-center align-bottom">{row.aderencia.toFixed(1).replace('.', ',')}%</td>
              ...
              <table className="w-full text-left text-sm text-gray-600 dark:text-zinc-300">
                <thead className="bg-gray-50 dark:bg-zinc-950 font-bold border-b border-gray-200 dark:border-zinc-800 uppercase text-[10px] tracking-wider text-gray-500">
                  <tr>
                    ...
                    <th className="px-6 py-3 w-24 text-center">Ponto</th>
