            ...
            <tbody className="divide-y divide-gray-100 dark:divide-zinc-800/50">
              <AnimatePresence mode="popLayout">
                {isLoading ? (
                  <tr>
                    <td colSpan={5} className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center justify-center space-y-3">
                        ...
                        <p className="text-gray-500 dark:text-zinc-400 font-medium">Buscando usuários no Supabase...</p>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-12 text-center text-gray-500 dark:text-zinc-400 font-medium italic">
