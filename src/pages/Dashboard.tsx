      ...
      <AnimatePresence mode="wait">
        {selectedUnit !== 'Todas' && (
          <motion.div
            ...
            className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-6 shadow-lg overflow-hidden"
          >
                    ...
                    <div>
                      ...
                      <div className="h-2.5 w-full bg-gray-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{ width: '70%' }}
                          className="h-full bg-[#6b778c] rounded-full"
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="h-2.5 w-full bg-gray-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{ width: `${actualOficialAuditoria}%` }}
                          className={`h-full ${getPerformanceStatus(actualOficialAuditoria).bg} rounded-full`}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center relative pl-4">
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className={`absolute inset-[-4px] rounded-full border-2 opacity-50 ${getPerformanceStatus(actualOficialAuditoria).bg.replace('bg-', 'border-').replace('/10', '/30')
                          }`}
                      />
      ...
      <AnimatePresence>
        {selectedUnit === 'Todas' && (
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-lg mt-8"
          >
