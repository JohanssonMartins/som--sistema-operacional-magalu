...
export const TopMagalogLogo = ({ className = '' }: { className?: string }) => (
  <motion.div
    ...
    className={`flex items-center gap-4 ${className} select-none group cursor-default`}
  >
    <div className="flex flex-col items-center">
      <div className="flex items-center gap-1">
        <span className="text-3xl sm:text-4xl font-black text-[#006CEE] tracking-tighter group-hover:scale-110 transition-transform duration-500" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>Top</span>
      ...
      <div className="flex items-center">
        <div className="flex flex-col gap-[2px] mr-1.5 mt-1">
          <div className="w-5 h-[3px] bg-yellow-400 rounded-full animate-pulse" style={{ boxShadow: '0 0 4px rgba(250,204,21,0.6)' }}></div>
          <div className="w-5 h-[3px] bg-red-500 rounded-full animate-pulse" style={{ animationDelay: '0.2s', boxShadow: '0 0 4px rgba(239,68,68,0.6)' }}></div>
